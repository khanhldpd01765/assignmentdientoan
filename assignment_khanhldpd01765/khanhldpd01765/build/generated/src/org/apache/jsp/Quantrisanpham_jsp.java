...
public final class Quantrisanpham_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <h1> Quản trị sản phẩm </h1>\n");
      out.write("               \n");
      out.write("                <table  border=\"0px\" > \n");
      out.write("                <span style=\"text-align: left \">\n");
      out.write("                    <tr>\n");
      out.write("                        <th>Mã sản phẩm: </th><td><input type=\"text\" name=\"Ma_sp\" value=\"");
      out.print(Model.GetProduct.masp);
      out.write("\" size=\"20\" /> </td>\n");
      out.write("                    </tr>\n");
      out.write("                    <tr>\n");
      out.write("                        <th>Tên sản phẩm: </th><td><input type=\"text\" name=\"Ten_sp\" value=\"");
      out.print(Model.GetProduct.tensp);
      out.write("\" size=\"20\" />  </td>\n");
      out.write("                    </tr>\n");
      out.write("                    <tr>\n");
      out.write("                        <th>Mô tả: </th><td><input type=\"text\" name=\"Mo_ta\" value=\"");
      out.print(Model.GetProduct.mota);
      out.write("\" size=\"20\" /> </td>\n");
      out.write("                    </tr>\n");
      out.write("                    <tr>\n");
      out.write("                        <th>Số lượng: </th><td><input type=\"text\" name=\"So_luong\" value=\"");
      out.print(Model.GetProduct.soluong);
      out.write("\" size=\"20\" /> </td>\n");
      out.write("                    </tr>\n");
      out.write("                    <tr>\n");
      out.write("                        <th>Đơn giá: </th><td><input type=\"text\" name=\"Don_gia\" value=\"");
      out.print(Model.GetProduct.dongia);
      out.write("\" size=\"20\" />VNĐ </td>\n");
      out.write("                    </tr>\n");
      out.write("                    <tr>\n");
      out.write("                        <th>Hình ảnh: </th><td><input type=\"text\" name=\"Hinh_anh\" value=\"");
      out.print(Model.GetProduct.hinhanh);
      out.write("\" size=\"20\" /> </td>\n");
      out.write("                    </tr>\n");
      out.write("                    <tr>\n");
      out.write("                        <th>Nhà sản xuất: </th><td><input type=\"text\" name=\"Nha_sx\" value=\"");
      out.print(Model.GetProduct.nhasx);
      out.write("\" size=\"20\" /> </td>\n");
      out.write("                    </tr>\n");
      out.write("                    <tr>\n");
      out.write("                        <th>Mã loại: </th><td><input type=\"text\" name=\"Ma_loai\" value=\"");
